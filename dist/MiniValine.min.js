    ...
    return function (e) {
        ...
        a.e = function (e) {
            ...
            return 0 !== l && (l ? c.push(l[2]) : (s = new Promise((function (t, n) {
                l = i[e] = [t, n]
            })), c.push(l[2] = s), (t = document.createElement("script")).charset = "utf-8", t.timeout = 120, a.nc && t.setAttribute("nonce", a.nc), t.src = a.p + "MiniValine." + ({1: "visitor"}[s = e] || s) + ".min.js", n = new Error, r = function (a) {
        ...
        }, a.p = "https://fastly.jsdelivr.net/gh/amehime/MiniValine@v4.2.2-beta10/dist/", a.oe = function (e) {
            throw console.error(e), e
        };
        var r = window.webpackJsonpMiniValine = window.webpackJsonpMiniValine || [], o = r.push.bind(r);
        r.push = t, r = r.slice();
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t.VERSION = "4.2.2", t.GBUrl = "https://gravatar.loli.net/avatar/", t.EUrl = ["https://fastly.jsdelivr.net/npm/alus@latest", "https://fastly.jsdelivr.net/gh/MiniValine/qq@master", "https://fastly.jsdelivr.net/gh/MiniValine/Bilibilis@master", "https://fastly.jsdelivr.net/gh/MiniValine/tieba@master", "https://fastly.jsdelivr.net/gh/MiniValine/twemoji@master", "https://fastly.jsdelivr.net/gh/MiniValine/weibo@master"], t.pf = "https://cdn.polyfill.io/v3/polyfill.min.js?features=es6", t.i18nUrl = "https://fastly.jsdelivr.net/gh/MiniValine/minivaline-i18n@latest/", t.DEHash = "9e63c80900d106cbbec5a9f4ea433a3e", t.MaxNL = 6, t.PS = 6, t.C = {
            ip: "",
            comment: "",
            rid: "",
            pid: "",
        ...
        e.exports = function (e) {
            ...
            var t = i(e.data), n = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
        ...
        e.exports = function (e, t) {
            try {
                var n = e.getTime(), a = (new Date).getTime() - n;
        ...
        "use strict";
        var i, a = (i = n(39)) && i.__esModule ? i : {default: i};
        e.exports = function (e, t, n) {
            var i = e.C.comment.match(/!\(:(.*?\.\w+):\)/g);
            if (i) for (var r = 0; r < i.length; r++) {
                var o = i[r].match(/!\(:(.*?\.\w+):\)/)[1], s = e.emoticon[o],
        ...
        "use strict";
        var i = s(n(13)), a = s(n(14)), r = s(n(15)), o = s(n(16));
        n = s(n(19));
        ...
        "use strict";
        var i, a = n(1), r = (i = n(4)) && i.__esModule ? i : {default: i};
        e.exports = function (e, t) {
            ...
            if (!e.config.closeFlag && e.config.cloudflag) try {
                var d = e.cloudFlag.Roles, f = t.get("mailMd5").toLowerCase();
        ...
        "use strict";
        var i, a = (i = n(17)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
        ...
        var a = i.getContext("2d"), r = [], o = 0, s = !1;
        ...
        e.exports = function () {
            for (var e = function () {
                ...
                if ("TEXTAREA" === e.tagName || "INPUT" === e.tagName && ("text" === e.getAttribute("type") || "email" === e.getAttribute("type"))) {
                    var t = n(18)(e, e.selectionEnd), i = e.getBoundingClientRect();
        ...
        function i(e, t, n) {
            ...
            var o = n.style, s = window.getComputedStyle ? getComputedStyle(e) : e.currentStyle;
        ...
        "use strict";
        var i, a = (i = n(20)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
        ...
        (function (t) {
            ...
            function i(e) {
                return function (t) {
                    var i = Array.prototype.slice.call(arguments, 1), a = 0, r = "UNDEFINED";
        ...
        "use strict";
        var i = N(n(22)), a = N(n(23)), r = N(n(24)), o = N(n(25)), s = N(n(26)), c = N(n(28)), l = N(n(29)),
            u = N(n(8)), d = N(n(30)), f = N(n(31)), g = N(n(32)), p = N(n(33)), m = N(n(34)), v = N(n(35)),
            h = N(n(36)), b = N(n(37)), y = N(n(38)), w = N(n(53)), _ = N(n(54)), E = N(n(55)), M = N(n(56)),
            x = N(n(59)), S = N(n(60)), C = N(n(61));
        n = N(n(62));
        ...
        "use strict";
        var _Default = __webpack_require__(1), _ajax = __webpack_require__(2), _ajax2 = _interopRequireDefault(_ajax);
        ...
        "use strict";
        var _ajax = __webpack_require__(2), _ajax2 = _interopRequireDefault(_ajax);
        ...
        var smile = function (e) {
            if (window.MV.emoticonUrl = e.emoticonUrl, window.MV.emoticonList) e.emoticonList = window.MV.emoticonList, e.emoticon = window.MV.emoticon; else {
                var t = localStorage && localStorage.getItem("_ValineSmile");
                if (t) if (equar((t = JSON.parse(t)).emoticonUrl, e.emoticonUrl)) {
                    e.emoticonList = t.emoticonList, e.emoticon = [];
                    for (var n = 0; n < e.emoticonList.length; n++) for (var i = 0; i < e.emoticonList[n].length; i++) e.emoticon[e.emoticonList[n][i].split("/")[e.emoticonList[n][i].split("/").length - 1]] = e.emoticonList[n][i];
                    window.MV.emoticonList = e.emoticonList, window.MV.emoticon = e.emoticon, window.MV.getSmile = 0
                } else window.MV.getSmile = 1; else window.MV.getSmile = 1;
            ...
            (0, _ajax2.default)({
                url: Url + "/index.json", type: "GET", success: function success(data) {
                    data = eval("(" + data + ")");
        ...
        e.exports = function (e) {
            ...
            var n = function (n) {
                if (n.length) for (var i = function () {
                    var i = n[o], s = "![Uploading ".concat(i.name, "]()");
            ...
            i.default.on("paste", document, (function (e) {
                var t = (e = "clipboardData" in e ? e.clipboardData : e.originalEvent && e.originalEvent.clipboardData || window.clipboardData) && e.items,
                    i = [];
                if (t && 0 < t.length) {
                    for (var a = 0; a < t.length; a++) if (-1 !== t[a].type.indexOf("image")) {
        ...
        "use strict";
        var i, a = (i = n(0)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
        ...
        "use strict";
        var i, a = (i = n(8)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
            var t = e.el.querySelector(".smile-icons"), n = e.el.querySelector(".preview-box");
            e.reset = function () {
        ...
        var i, a = (i = n(0)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
            var t = e.el.querySelector(".emojis"), n = e.el.querySelector(".preview"),
                i = e.el.querySelector(".preview-box"), r = e.el.querySelector(".smile-body");
        ...
        var i, a = (i = n(0)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
            var t = e.el.querySelector(".preview"), n = e.el.querySelector(".emoji"),
                i = e.el.querySelector(".preview-box"), r = e.el.querySelector(".smile-icons");
            a.default.on("click", t, (function (a) {
                if (r.getAttribute("triggered") && (r.setAttribute("style", "display:none;"), r.removeAttribute("triggered"), n.classList.remove("actived")), i.getAttribute("triggered")) i.setAttribute("style", "display:none;"), i.removeAttribute("triggered"), t.classList.remove("actived"); else {
        ...
        e.exports = function (e) {
            for (var t in e.inputs = {}, e.mapping = {
                ...
                var n = e.mapping[t], i = e.el.querySelector(".".concat(t));
        ...
        e.exports = function (e) {
            e.AtEvt = function (t) {
                var n = t.getAttribute("id"), i = t.querySelector("#at-".concat(n));
                a.default.on("click", i, (function (a) {
                    var r = i.getAttribute("at"), o = i.getAttribute("rid");
        ...
        e.exports = function (e) {
            ...
            e.submitEvt = function (i) {
                ...
                t.getAttribute("disabled") ? e.alert.show({
                    ...
                    var t = r.default.mail(e.C.mail), i = r.default.link(e.C.link);
        ...
        "use strict";
        var i, a = (i = n(3)) && i.__esModule ? i : {default: i}, r = n(40);
        e.exports = function (e, t, n) {
            !e.md && void 0 !== e.config.md || (t.TEXT = (0, r.markdown)(t.TEXT)), (0, a.default)(t, n)
        }
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t.markdown = function (e) {
        ...
        var i, a = (i = n(41)) && i.__esModule ? i : {default: i}
    }, function (e, t, n) {
        "use strict";
        var i = n(42);
        ...
        var f = function () {
            ...
            return u(e, [{
                key: "ignoreMatch", value: function () {
                    this.ignore = !0
                }
            }]), e
        }();
        ...
        var v = Object.freeze({
            __proto__: null, escapeHTML: g, inherit: p, nodeStream: function (e) {
                var t = [];
                return function e(n, i) {
                    for (var a = n.firstChild; a; a = a.nextSibling) 3 === a.nodeType ? i += a.nodeValue.length : 1 === a.nodeType && (t.push({
                        ...
                        offset: i,
                        node: a
                    }), i = e(a, i), m(a).match(/br|hr|img|input/) || t.push({event: "stop", offset: i, node: a}));
                    return i
                }(e, 0), t
        ...
        var E = "[a-zA-Z]\\w*", M = "[a-zA-Z_]\\w*", x = "\\b\\d+(\\.\\d+)?",
            S = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", C = "\\b(0b[01]+)",
            ...
            j = {className: "number", begin: x, relevance: 0}, D = {className: "number", begin: S, relevance: 0},
            P = {className: "number", begin: C, relevance: 0}, B = {
                className: "number",
            ...
            }, U = {className: "title", begin: E, relevance: 0}, z = {className: "title", begin: M, relevance: 0},
            V = {begin: "\\.\\s*" + M, relevance: 0}, H = Object.freeze({
                __proto__: null,
                IDENT_RE: E,
            ...
            return function i(a, s) {
                ...
                return c.keywordPatternRe = t(a.lexemes || u || /\w+/, !0), s && (a.beginKeywords && (a.begin = "\\b(" + a.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)", a.__beforeBegin = o), a.begin || (a.begin = /\B|\b/), c.beginRe = t(a.begin), a.endSameAsBegin && (a.end = a.begin), a.end || a.endsWithParent || (a.end = /\B|\b/), a.end && (c.endRe = t(a.end)), c.terminator_end = _(a.end) || "", a.endsWithParent && s.terminator_end && (c.terminator_end += (a.end ? "|" : "") + s.terminator_end)), a.illegal && (c.illegalRe = t(a.illegal)), void 0 === a.relevance && (a.relevance = 1), a.contains || (a.contains = []), a.contains = (u = []).concat.apply(u, n(a.contains.map((function (e) {
                    return function (e) {
                        ...
                        }(e) ? p(e, {starts: e.starts ? p(e.starts) : null}) : Object.isFrozen(e) ? p(e) : e
                    }("self" === e ? a : e)
                ...
                })), s.terminator_end && l.addRule(s.terminator_end, {type: "end"}), s.illegal && l.addRule(s.illegal, {type: "illegal"}), l), c
            }(e)
        }
        ...
        }, X = g, Q = p, J = v.nodeStream, Z = v.mergeStreams, W = Symbol("nomatch");
        v = function (e) {
            var t = [], n = Object.create(null), a = Object.create(null), r = [], o = !0, s = /(^(<[^>]+>|\t|)+|\n)/gm,
                c = "Could not find the language '{}', did you forget to load/include a language module?",
                l = {disableAutodetect: !0, name: "Plain text", contains: []}, u = {
            ...
            function m(e, t, a, r) {
                ...
                function h(t, n) {
                    ...
                    if ("end" === n.type && (r = function (e) {
                        var t = e[0], n = s.substr(e.index), i = function e(t, n, i) {
                ...
                t = K(b);
                var y = "", w = r || t, _ = {}, M = new u.__emitter(u);
                !function () {
                ...
                try {
                    ...
                    if (t.message && t.message.includes("Illegal")) return {
                        illegal: !0,
                        illegalBy: {msg: t.message, context: s.slice(C - 100, C + 100), mode: t.mode},
                        sofar: y,
                        relevance: 0,
                        value: X(s),
                        emitter: M
            ...
            for (y in Object.assign(e, {
                highlight: p, highlightAuto: v, fixMarkup: function (e) {
                ...
                }, highlightBlock: b, configure: function (e) {
                    u = Q(u, e)
                }, initHighlighting: _, initHighlightingOnLoad: function () {
                ...
                }, getLanguage: E, registerAliases: M, requireLanguage: function (e) {
                    var t = E(e);
                    if (t) return t;
                    throw new Error("The '{}' language is required, but not loaded.".replace("{}", e))
                }, autoDetection: x, inherit: Q, addPlugin: function (e) {
                    r.push(e)
                }, vuePlugin: G
        ...
        e.exports = function (e) {
            var t = {className: "symbol", begin: "&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;"}, n = {
                ...
                r = e.inherit(e.QUOTE_STRING_MODE, {className: "meta-string"}), o = {
                    endsWithParent: !0,
                    illegal: /</,
                    relevance: 0,
            ...
            return {
                ...
                contains: [{
                    ...
                    contains: [n, r, a, i, {
                        ...
                        contains: [{className: "meta", begin: "<![a-z]", end: ">", contains: [n, i, r, a]}]
                    }]
        ...
        e.exports = function (e) {
            var t = {literal: "true false null"}, n = [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE],
                ...
                a = {end: ",", endsWithParent: !0, excludeEnd: !0, contains: i, keywords: t}, r = {
                    begin: "{",
                    end: "}",
                    contains: [{
                        className: "attr",
        ...
        e.exports = function (e) {
            var t = {}, n = {begin: /\$\{/, end: /\}/, contains: [{begin: /:-/, contains: [t]}]};
        ...
        e.exports = function (e) {
            ...
            return {
                ...
                contains: [e.HASH_COMMENT_MODE, {
                    ...
                    returnBegin: !0,
                    contains: [{className: "attribute", begin: e.UNDERSCORE_IDENT_RE, starts: t}],
                    relevance: 0
                }],
                illegal: "[^\\s\\}]"
            }
        ...
        e.exports = function (e) {
            var t = n, c = {begin: /<[A-Za-z0-9\\._:-]+/, end: /\/[A-Za-z0-9\\._:-]+>|\/>/},
                l = {$pattern: n, keyword: i.join(" "), literal: a.join(" "), built_in: r.join(" ")}, u = {
                    className: "number",
                    variants: [{begin: "\\b(0[bB][01]+)n?"}, {begin: "\\b(0[oO][0-7]+)n?"}, {begin: e.C_NUMBER_RE + "n?"}],
                    relevance: 0
                }, d = {className: "subst", begin: "\\$\\{", end: "\\}", keywords: l, contains: []}, f = {
                    begin: "html`",
                    end: "",
            ...
            return {
                ...
                keywords: l,
                contains: [e.SHEBANG({binary: "node", relevance: 5}), {
                    className: "meta",
                    relevance: 10,
                    ...
                    begin: s(/[{,\n]\s*/, o(s(/(((\/\/.*$)|(\/\*(.|\n)*\*\/))\s*)*/, t + "\\s*:"))),
                    relevance: 0,
                    contains: [{className: "attr", begin: t + o("\\s*:"), relevance: 0}]
                }, {
                    ...
                    contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, e.REGEXP_MODE, {
                        ...
                        contains: [{
                            ...
                            variants: [{begin: e.UNDERSCORE_IDENT_RE}, {
                                ...
                                begin: /\(\s*\)/,
                                skip: !0
                            }, {begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: l, contains: m}]
                        }]
                    }, {begin: /,/, relevance: 0}, {
                        className: "",
                        begin: /\s/,
                    ...
                    excludeEnd: !0,
                    contains: [e.inherit(e.TITLE_MODE, {begin: t}), d],
                    illegal: /\[|%/
                    ...
                    keywords: "get set",
                    contains: [e.inherit(e.TITLE_MODE, {begin: t}), {begin: /\(\)/}, d]
                }],
                illegal: /#(?!!)/
            }
        }
        ...
        e.exports = function (e) {
            var t = "false synchronized int abstract float private char boolean var static null if const for true while long strictfp finally protected import native final void enum else break transient catch instanceof byte super volatile case assert short package default double public try this switch continue throws protected public private module requires exports do",
                n = {
                    ...
                    className: "number",
                    variants: [{begin: "\\b(0[bB]".concat(o("01"), ")[lL]?")}, {begin: "\\b(0".concat(o("0-7"), ")[dDfFlL]?")}, {begin: a(/\b0[xX]/, r(a(o("a-fA-F0-9"), /\./, o("a-fA-F0-9")), a(o("a-fA-F0-9"), /\.?/), a(/\./, o("a-fA-F0-9"))), /([pP][+-]?(\d+))?/, /[fFdDlL]?/)}, {begin: a(/\b/, r(a(/\d*\./, o("\\d")), o("\\d")), /[eE][+-]?[\d]+[dDfF]?/)}, {begin: a(/\b/, o(/\d/), i(/\.?/), i(o(/\d/)), /[dDfFlL]?/)}],
                    relevance: 0
                };
            return {
                name: "Java",
        ...
        e.exports = function (e, t) {
            e.insertComment = function (i) {
                ...
                if (r) s.insertBefore(o, a[0]); else try {
                    s.appendChild(o)
                } catch (e) {
                }
        ...
        var i, a = (i = n(58)) && i.__esModule ? i : {default: i};
        ...
        "use strict";
        var i;
        Object.defineProperty(t, "__esModule", {value: !0}), t.initMathJax = function () {
        ...
        "use strict";
        var i, a = (i = n(9)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
            e.previewEvt = function (e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0,
                    n = e.el.querySelector(".preview"), i = e.el.querySelector(".preview-box"),
                    r = e.el.querySelector(".veditor"), o = function (i) {
        ...
        "use strict";
        var i, a = (i = n(4)) && i.__esModule ? i : {default: i};
        e.exports = function (e) {
            !function (e) {
